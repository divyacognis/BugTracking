<div class="wrapper">
            ...
            <div class="header">
				...
				<table>
					...
					<div class="title">Crew <span class="title">Payroll</span> for HQ User</div>                    
	                    <ul>
                ...
                <div class="sidebar-menu">
                    ...
                    <li class="item" id="settings">
                        ...
                        <div class="sub-menu">
							...
							<a href="CompanySetup?#settings"><i class="fas clock-o"></i><span>Vessel Setup</span></a>
							<a href="HqAddCrewUser?#settings"><i class="fas clock-o"></i><span>Crew Details</span></a>
							<a href="userPage?#settings"><i class="fas clock-o"></i><span>User Details</span></a>
                        </div>
                    </li>
